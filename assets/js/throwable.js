!(function($) {
    ...
    const restArguments = function(t, e) {
            return (
                ...
                function(i, s) {
                    for (
                        var n = Math.max(arguments.length - e, 0), o = Array(n), a = 0; a < n; a++
                    )
                        o[a] = arguments[a + e];
                    switch (e) {
                        case 0:
    ...
    class ThrowableScene {
        ...
        createBoundaries() {
            ...
            this.boundLeft = Matter.Bodies.rectangle(-wallThickness / 2,
                this.height / 2,
                wallThickness,
                this.height * 2,
                boundaryOptions
        ...
        createBodies() {
            ...
            this.DOM.throwables.forEach((throwable, index) => {
                ...
                const chamfer =
                    this.options.roundness === "sharp" ? null : {
                        radius: 10
                    };
        ...
        refresh() {
            ...
            if (this.boundLeft) {
                Matter.Body.setPosition(this.boundLeft, {
                    x: -25,
                    y: this.height / 2
                });
            }
            ...
            if (this.boundTop) {
                Matter.Body.setPosition(this.boundTop, {
                    x: this.width / 2,
                    y: -25
                });
            }
